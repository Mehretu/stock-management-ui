...
export default function DeleteSelected({ selectedRows, resourceName,reload }) {
    ...
    return (
        <button
            ...
            className={`text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1 me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900 sm:w-auto ${loading ? 'cursor-not-allowed opacity-50' : ''}`}
            disabled={loading}
        >
