...
export default function SalesOrderCard({salesOrders}) {

    const salesDate = convertIsoToDate(salesOrders.createdAt)
                            ...
                            <div className="px-4 py-6 sm:p-6 lg:p-8">
                                <div className="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-1">
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-gray-900 mt-0.5">{salesOrders.referenceNumber}</p>
                                    </div>

                                    <div>
                                        <p className="text-sm font-medium text-gray-500">Date</p>
                                        <p className="text-sm font-bold text-gray-900 mt-0.5">{salesDate}</p>
                                    </div>

                                    <div>
                                        <p className="text-sm font-medium text-gray-500">Total Amount</p>
                                        <p className="text-sm font-bold text-gray-900 mt-0.5">{salesOrders.orderTotal}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-0.5 flex items-center">
                                            ...
                                            <span className="text-sm font-bold text-gray-900"> {salesOrders.orderStatus}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
