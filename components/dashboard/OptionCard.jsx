...
export default function OptionCard({optionData}) {
  ...
  return (
        <div className='shadow-md bg-white flex flex-col items-center justify-center gap-4 p-6 rounded' >
              ...
              {enabled?(
                <Link href={link} className=' py-2 p-1 bg-blue-600 rounded-sm inline-flex items-center space-x-2 px-3 text-white'>             
                {linkTitle}
              </Link> 
              ):(
                <button className=' py-2 p-1 bg-blue-600 rounded-sm inline-flex items-center space-x-2 px-3 text-white'>Enable</button>
